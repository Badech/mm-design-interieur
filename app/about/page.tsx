      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 max-w-5xl mx-auto">
            ...
            <div className="text-center p-8 bg-secondary rounded-lg">
              <div className="text-5xl mb-4">🎨</div>
              <h3 className="text-xl font-heading font-bold text-primary mb-3">Créativité</h3>
              <p className="text-secondary-gray">
                Chaque projet est unique, conçu sur mesure selon votre vision.
              </p>
            </div>
            <div className="text-center p-8 bg-secondary rounded-lg">
              <div className="text-5xl mb-4">🤝</div>
              <h3 className="text-xl font-heading font-bold text-primary mb-3">Confiance</h3>
              <p className="text-secondary-gray">
                Votre satisfaction et confiance sont au cœur de notre approche.
              </p>
            </div>
          </div>
        </div>
