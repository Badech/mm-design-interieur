...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-50 bg-[#25D366] text-white p-4 sm:p-5 rounded-full shadow-2xl hover:bg-[#20BA5A] transition-all duration-300 hover:scale-110 group focus:outline-none focus:ring-4 focus:ring-[#25D366]/40"
